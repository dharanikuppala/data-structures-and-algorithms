...
6. Palindrome Linked List - [Problem Link](https://leetcode.com/problems/palindrome-linked-list/) , [Java Solution](06-linkedlist/09_palindrome_linked_list.java) ,Pattern: Fast & Slow + Reverse List 
