...
7. Construct Binary Tree from Preorder and Inorder Traversal - [Problem Link](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) , [Java Solution](09-trees/15_construct_tree_preorder_inorder.java) , Pattern: Divide & Conquer (Tree Construction)
