...
4. First Unique Character in a String - [Problem Link](https://leetcode.com/problems/first-unique-character-in-a-string/) , [Solution](04-strings/05_first_unique_character.java) , Pattern: Hashing / Frequency Counting
