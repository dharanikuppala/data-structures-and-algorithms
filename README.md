...
6. Lowest Common Ancestor of a Binary Tree - [Problem Link](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/) , [Java Solution](09-trees/14_lowest_common_ancestor.java) , Pattern: DFS (Post-order)
