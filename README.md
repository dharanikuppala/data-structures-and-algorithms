...
5. Remove Nth Node From End of List - [Problem Link](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) , [Solution](06-linkedlist/12_remove_nth_node_from_end.java) , Pattern: Two Pointers / Fast & Slow
